...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $lokasi_pedagang = $_POST['lokasi'];

    // Proses file gambar
    $gambar_path = "path_ke_gambar_default.jpg"; // default path
    ...
    $sql = "INSERT INTO t_mitra (nama, lokasi, gambar_path) VALUES ('$nama_pedagang', '$lokasi_pedagang', '$gambar_path')";
        ...
        echo '<script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "pedagang_terpercaya.php";
                }
            });
        </script>';
    } else {
...
<!--FORM PENGISIAN DATA PEDAGANG TERPERCAYA-->
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4" style="margin-top: 100px;">
            <h1 class="mt-4"><b>Input Pedagang Terpercaya</b></h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="dashboard_admin.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Pedagang Terpercaya</li>
            </ol>
            <div class="card mb-4">
                <div class="card-body">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama" placeholder="Contoh : Warung Nasi Kabita"required>
                        </div>
                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi:</label>
                            <input type="text" class="form-control" name="lokasi" placeholder="Contoh : Jalan Malabar"required>
                        </div>
                        <div class="mb-3">
                            <label for="gambar" class="form-label">Gambar: (Direktori Default C:\xampp\htdocs\vokasilaper\image) <b>Selain Itu Tidak Bisa</b></label>
