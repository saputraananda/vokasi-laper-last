<?php
	...
	if(isset($_SESSION['username_restaurant_qRewacvAqzA']) && isset($_SESSION['password_restaurant_qRewacvAqzA']))
	{
		...
		include 'includes/templates/header-berhasil-login.php';
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="above-table" style="margin-bottom: 1rem!important;">
                            <a href="makanan.php?do=Add" class="btn btn-success">
                                                        ...
                                                        <ul class="list-inline m-0">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="thumbnail" style="cursor:pointer">
                                                                                    <?php $source = "../images/".$menu['menu_image']; ?>
                                                                                    <img src="<?php echo $source; ?>" >
                                                                                    <div class="caption">
                                                                                        <h3>
                                                                                            <span style="float: right;">Rp<?php echo $menu['menu_price'];?></span>
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Edit">
                                                                <button class="btn btn-success btn-sm rounded-0">
                                                                    <a href="makanan.php?do=Edit&menu_id=<?php echo $menu['menu_id']; ?>" style="color: white;">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Delete">
                                                                <button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="modal" data-target="#<?php echo $delete_data; ?>" data-placement="top"><i class="fas fa-trash"></i>
                                                                </button>
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body black">
                                                                                <p>Are you sure you want to delete this Menu "<?php echo strtoupper($menu['menu_name']); ?>"?</p>
                                                                            </div>
            ...
            elseif($do == 'Add')
            {
                ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" class="menu_form" action="makanan.php?do=Add" enctype="multipart/form-data">
                                <div class="panel-X">
                                    ...
                                    <div class="panel-body-X">
                                        ...
                                        <div class="form-group">
                                            <label for="menu_price">Menu Price(Rp)</label>
                ...
                if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_menu_form == 0)
                {
                    ...
                    move_uploaded_file($_FILES['menu_image']['tmp_name'],"/vokasilaper/images/".$image);
                    ...
                    try
                    {
                        ...
                        ?> 
                            ...
                            <script type="text/javascript">
                                ...
                                {
                                    window.location.replace("makanan.php");
                                });
                            </script>
                ...
                if($menu_id)
                {
                    ...
                    if($count > 0)
                    {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" class="menu_form" action="makanan.php?do=Edit&menu_id=<?php echo $menu['menu_id'] ?>" enctype="multipart/form-data">
                                    <div class="panel-X">
                                        <div class="panel-header-X">
                                            <div class="main-title">
                                                <?php echo $menu['menu_name']; ?>
                        ...
                        if(isset($_POST['edit_menu_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_menu_form == 0)
                        {
                            ...
                            {
                                $image = rand(0,100000).'_'.$_FILES['menu_image']['name'];
                                move_uploaded_file($_FILES['menu_image']['tmp_name'],"../images/".$image);
                                try
                                {
...
<script type="text/javascript">
    ...
    $('.delete_menu_bttn').click(function()
    {
        ...
        $.ajax(
        {
            url:"ajax_files/makanan_ajax.php",
            method:"POST",
